			...
			<div className="container pt-5 pb-5">
				<div className="row align-items-center justify-content-center">
					<div className="col-lg-6 col-md-12 text-align-start">
						<p className='mb-2' style={{color: '#A8DADC', fontWeight: 'bolder', borderBottom: '3px solid #27697B', width: '80px'}}>Book Apointment</p>
						<h1 className='mb-2' style={{fontWeight: 'bold'}}>Book Appointment And Get Medical Treatment Now</h1>
